...
console.log(color('BASE RIFKY MENGINTAI DARI JAUH KAMI TAU APA YG ANDA LAKUKAN PD BOT','red'))
...
break
		...
		case 'request':
					...
					client.sendMessage('6288227606701@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6288227606701@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER(RIFKY) REQUESTS PALSU ATAU MAIN² TIDAK AKAN DITANGGAPI.')
					break
		case 'blocklist': 
